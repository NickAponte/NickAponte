...
- 🎓 &nbsp; Graduated with a Bachelors degree in C.S from Montclair state University
- 🎓 &nbsp; Soon to be a General Assembly Software engineering Immersive boot camp graduate!
- 🌱 &nbsp; Learning more about popular front end/ back end frameworks like React/ Mongo DB /Express in Javascript, and Postgres/Django for python
- ✍️ &nbsp; Pursuing game design in Phaser.io as a hobby, along with studying cryptocurrency and hoping to break into that sector 
